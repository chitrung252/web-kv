        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
            <div class="staff">
              ...
              <div
                class="img mb-4"
                style="
                  background-image: url(https://khopviet.com/storage/app/media/23561807_1507057892681263_6339143052412612156_n.jpg);
                "
              ></div>
              <div class="info text-center">
                <h3><a href="teacher-single.html">NGUYỄN VIẾT TÂN</a></h3>
          ...
          <div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
            <div class="staff">
              <div
                class="img mb-4"
                style="background-image: url(../assets/images/person_4.jpg)"
              ></div>
              <div class="info text-center">
                <h3><a href="teacher-single.html">Ivan Dorchsner</a></h3>
                <span class="position">System Analyst</span>
